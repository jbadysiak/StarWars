...
/**
 * Klasa Animation zawiera animacje Sprit'ów
 *
 *
 */
public class Animation {

	/** Szybkoœæ zmiany Sprite'a */
	private int speed;
	/** Iloœæ ramek dla danego Sprite'a */
	private int frames;
	/** Index ka¿dego Sprie'a */
	private int index = 0;
	/**Liczba Sprit'ów w mo¿liwym przypadku */
	private int count = 0;
	
	/** Deklaracja obrazków potrzebnych do Sprit'ów */
	...
	/** Deklaracja bie¿¹cego obrazka */ 
	private BufferedImage currentImg;
	//13 frame animation
	/** Deklaracja metody Animacji, gdy mamy 14 obrazków */ 
	...
	//13 frame animation
	/** Deklaracja metody Animacji, gdy mamy 13 obrazków */ 
	...
	//12 frame animation
	/** Deklaracja metody Animacji, gdy mamy 12 obrazków */ 
	...
	//11 frame animation
	/** Deklaracja metody Animacji, gdy mamy 11 obrazków */ 
	...
	//10 frame animation
	/** Deklaracja metody Animacji, gdy mamy 10 obrazków */ 
	...
	// 9 frame
	/** Deklaracja metody Animacji, gdy mamy 9 obrazków */ 
	...
	//8 frame
	/** Deklaracja metody Animacji, gdy mamy 8 obrazków */ 
	...
	//7 frame
	/** Deklaracja metody Animacji, gdy mamy 7 obrazków */ 
	...
	//6 frame
	/** Deklaracja metody Animacji, gdy mamy 6 obrazków */ 
	...
	//5 frame
	/** Deklaracja metody Animacji, gdy mamy 5 obrazków */ 
	...
	//4 frame
	/** Deklaracja metody Animacji, gdy mamy 4 obrazki */ 
	...
	//3 frame
	/** Deklaracja metody Animacji, gdy mamy 3 obrazki */
	...
	//2 frame
	/** Deklaracja metody Animacji, gdy mamy 2 obrazki */
	...
	/**
	 * Metoda wywo³uj¹ca poruszanie siê animacji
	 */
	...
	/** Metoda wyœwietlaj¹ca kolejne obrazki */  
	...
	/** Metoda rysowania animacji */
	public void drawAnimation(Graphics g, double x, double y, int offset){
		g.drawImage(currentImg, (int)x - offset, (int)y, null);
	}
	/** Metoda ustawiaj¹ca wartoœæ licznika 
	 *  obrazków dla danego obrazka 
	 * 
	 */
	public void setCount(int count){
		this.count = count;
	}
	/** Metoda pobieraj¹ca wartoœæ licznika obrazków */
	public int getCount(){
		return count;
	}
	/** Pobranie wartoœci szybkoœci */
	public int getSpeed(){
		return speed;
	}
	/** Ustawienie wartoœci szybkoœci */
